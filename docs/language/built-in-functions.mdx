...
`cadence•fun unsafeRandom(): UInt64`
  ...
  Follow [best practices](https://github.com/ConsenSys/smart-contract-best-practices/blob/18e446414ad22377e7f205056af6f2e96971dcf7/docs/development-recommendations/general/public-data.md)
  to prevent security issues when using this function.
  
  **Also note that this function returns the exact same random number to every call within the same block.**
